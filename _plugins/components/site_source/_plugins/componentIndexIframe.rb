module Jekyll
  class ComponentIndexIframeTag < Liquid::Block
    def render(context)
      ...
      site.used_components.capture_and_write_to dir, "#{name}-" do
        ...
        iframe_page.data['permalink'] = url
        iframe_page.data['asset_path'] = "#{url}-"
        iframe_page.data['iframe'] = true
  ...
  Liquid::Template.register_tag('componentIndexIframe', ComponentIndexIframeTag)
end