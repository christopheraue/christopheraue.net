---
layout: article
title: 'Layouts Using em: Font-Size As Global Scaling Factor'
category: articles
tags: font-size em layout
image: iamge
excerpt: excerpt
...
> While it is possible to do an entire layout with just em units, I think for responsive layouts it’s probably best to use pixels \[...\] — and, as mentioned, use ems for typography.
...
But that's what it is, just a number. It will do all the work for you once it is there.
